import Producto from "./components/Header";
import Producto1 from "./components/MyCard";
...
function App () {
  return (
    <>
    <Producto title="Adopta un Perrito" />
    <Producto1
    ...
    tag="Boxer"
    />
    <Final piePagina="El perro, llamado perro doméstico o can y en algunos lugares coloquialmente llamado chucho, tuso, choco, entre otros; es un mamífero carnívoro de la familia de los cánidos, que constituye una especie del género Canis"
    />
    </>
  )
}
